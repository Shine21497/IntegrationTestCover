package com.shine.integrationtestcover.service.graphCustom;
...
public class Test {
    public static void main(String[] args) throws Exception {
        BufferedReader br = new BufferedReader(new FileReader("temp3.txt"));
        try {
...
//            System.out.println(result);
            ...
            graph.getVertexList();
            System.out.println("metrics1"+graph.metrics1());
            System.out.println("metrics3"+graph.metrics3(4));
            System.out.println("baseline");
            graph.findBaseLine();
            graph.metric2();
            System.out.println("entry"+graph.findEntry());
            graph.findBaseLine();
